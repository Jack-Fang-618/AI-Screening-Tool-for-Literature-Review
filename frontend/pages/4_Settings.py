...
- Pediatric populations (under 18 years)"""
    ...
    with tab3:
        ...
        with col1:
            ...
            current_default = st.session_state.settings.get('default_model', 'grok-4-1-fast-reasoning')
            try:
                default_index = options.index(current_default)
            except ValueError:
                default_index = 0
            ...
            default_model = st.selectbox(
                ...
                options=options,
                index=default_index,
                help="The default model to use for new screening tasks. Grok 4.1 series is recommended."
            )
